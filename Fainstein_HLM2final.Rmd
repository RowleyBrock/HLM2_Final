...
#looking at probability per substance
brms::inv_logit_scaled(fixef(subxrace_brm))
...
# case_when(RaceEthnicity == 1 ~ "Native",
#RaceEthnicity == 2 ~ "Asian",
#RaceEthnicity == 3 ~ "Latinx",
#RaceEthnicity == 4 ~ "Black",
#RaceEthnicity == 5 ~ "White",
...
credible interval range [ - ]), and the probability is 89% (95% range: [% - %]).
As a basis of comparison example, let's also examine OSS for drugs as a white
student: log-odds are 1.57 (95% credible interval range [ - ]), and the
probability is 82% (95% range: [% - %]). For a more direct comparison of these
two cases, the difference between groups was computed based on the posterior
distribution. Black students were approximately 3 times more likely than white
students to receive a first-time OSS for drugs (20.8% likelihood for white
students versus a 63.0% likelihood for black students).
