...
Procedure
  ...
  Tips on missing data? Listwise deletion? 2k of 30k students missing race info
...
We should plot each model if possible, although the interaction model might be difficult. 
